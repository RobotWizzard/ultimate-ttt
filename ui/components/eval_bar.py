import pygame
from ui.config import SMALL_FONT
...
class EvalBar:
    ...
    def draw(self, screen):
        ...
        self.display_value += (max(-self.max_eval, min(self.max_eval, self.value)) - self.display_value) * 0.2
        ...
        eval_text = self.font.render(str(self.value), True, (0, 0, 0))
        ...
        x_text = pygame.font.SysFont("Berlin Sans FB", 24).render("X", True, (200, 50, 50))
        o_text = pygame.font.SysFont("Berlin Sans FB", 24).render("O", True, (100, 100, 240))
